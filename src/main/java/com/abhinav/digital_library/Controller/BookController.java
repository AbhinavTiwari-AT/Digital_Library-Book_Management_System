...
import com.abhinav.digital_library.Services.BooksService;
...
public class BookController {
	...
	{
	      Book added = booksService.addBook(book);
	...
	{
		List<Book> book = booksService.getAllBooks();
	...
	{
		Book update = booksService.updateBook(bookId, book);
